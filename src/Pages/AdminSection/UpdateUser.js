...
const UpdateUser = () => {
    ...
    useEffect(() => {
        fetch(`https://travelagencymarketingwebsite-63327e68d494.herokuapp.com/users/${id}`)
            .then((res) => res.json())
    ...
    const handleUser = (event) => {
        ...
        const url = `https://travelagencymarketingwebsite-63327e68d494.herokuapp.com/upadete-users/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
