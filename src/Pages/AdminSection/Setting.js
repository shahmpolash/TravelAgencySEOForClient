                            ...
                            <div class="container text-center">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3  col-md-6 col-12">
                                        ...
                                        <div className='single-card'>
                                            <Link to='/edit-info'>  <img src={image} /> Info Setting</Link>
                                        </div>
                                    </div>
                                    <div class="col-lg-3  col-md-6 col-12">

                                        <div className='single-card'>
                                            <Link to='/edit-faq'>  <img src={steps} /> FAQ Setting</Link>
                                        </div>
                                    </div>
                                    <div class="col-lg-3  col-md-6 col-12">
                                    ...
                                    <div class="col-lg-3  col-md-6 col-12">
                                        ...
                                        <div className='single-card'>
                                            <Link to='/add-pricing'> <img src={price} /> Pricing</Link>
                                        </div>
                                    </div>
                                    <div class="col-lg-3  col-md-6 col-12">
                                        <div className='single-card'>
                                    ...
                                    <div class="col-lg-3  col-md-6 col-12">
                                        <div className='single-card'>
                                            <Link to='/add-instagram-url'> <img src={footerad} /> Instagram Feeds</Link>
                                        </div>
