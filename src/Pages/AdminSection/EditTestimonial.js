...
const EditTestimonial = () => {
    ...
    useEffect(() => {
        fetch(`https://travelagencymarketingwebsite-63327e68d494.herokuapp.com/testimonial/${id}`)
            .then((res) => res.json())
    ...
    const handleTestimonialSection = (event) => {
        ...
        const url = `https://travelagencymarketingwebsite-63327e68d494.herokuapp.com/testimonial/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
