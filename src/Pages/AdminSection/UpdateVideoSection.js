...
const UpdateVideoSection = () => {
    ...
    useEffect(() => {
        fetch(`https://travelagencymarketingwebsite-63327e68d494.herokuapp.com/video/${id}`)
            .then((res) => res.json())
    ...
    const handleVideoSection = (event) => {
        ...
        const url = `https://travelagencymarketingwebsite-63327e68d494.herokuapp.com/update-video/${id}`;
        fetch(url, {
            method: "PUT",
            headers: {
