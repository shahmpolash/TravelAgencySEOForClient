...
const AddProduct = () => {
  ...
  useEffect(() => {
    fetch(`https://travelagencymarketingwebsite-63327e68d494.herokuapp.com/products-variation`)
      .then((res) => res.json())
  ...
  const handleAddProduct = (event) => {
    ...
    const url = `https://travelagencymarketingwebsite-63327e68d494.herokuapp.com/add-product`;
    fetch(url, {
      method: "POST",
      headers: {
