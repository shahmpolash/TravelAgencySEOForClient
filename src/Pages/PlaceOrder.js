...
const PlaceOrder = () => {
  ...
  useEffect(() => {
    fetch(`https://travelagencymarketingwebsite-63327e68d494.herokuapp.com/cash-on-delivery`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(`https://travelagencymarketingwebsite-63327e68d494.herokuapp.com/payment-accounts`)
      .then((res) => res.json())
  ...
  const handlePlaceOrderCashOnDelivery = (event) => {
    ...
    const url = `https://travelagencymarketingwebsite-63327e68d494.herokuapp.com/new-order-cash-on-delivery`;
    fetch(url, {
      method: "POST",
      headers: {
        "content-type": "application/json",
