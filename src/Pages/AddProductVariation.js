...
const AddProductVariation = () => {
  ...
  useEffect(() => {
    fetch(`https://travelagencymarketingwebsite-63327e68d494.herokuapp.com/product-variation/${id}`)
      .then((res) => res.json())
  ...
  const handleVariation = (event) => {
    ...
    const url = `https://travelagencymarketingwebsite-63327e68d494.herokuapp.com/add-variation/${variation._id}`;
    fetch(url, {
      method: 'PUT',
      headers: {
