...
const HomeSectionThree = () => {
  ...
  useEffect(() => {
    fetch("https://travelagencymarketingwebsite-63327e68d494.herokuapp.com/products")
      .then((res) => res.json())
      .then((info) => setProducts(info));
  }, []);

  useEffect(() => {
    fetch(`https://travelagencymarketingwebsite-63327e68d494.herokuapp.com/sections-three/`)
      .then((res) => res.json())
